...
//		return LimitOrderMatching.orderMatching(orderReq.getStockNo(), bidMap, askMap);
		synchronized (this) {
			...
			case "L":
				return LimitOrderMatching.orderMatching(orderReq.stockNo(), bidMap, askMap);
			case "M":
				return MarketOrderMatching.orderMatching(orderReq.stockNo(), this.nominalPrice, bidMap, askMap);
			default:
				return null;
			}
		}
